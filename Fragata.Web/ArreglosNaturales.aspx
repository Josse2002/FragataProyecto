<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArreglosNaturales.aspx.cs" Inherits="Fragata.Web.ArreglosNaturales" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Arreglos Naturales</title>
        ...
        <section class="grid images" id="grid">
          ...
          <div class="item" data-categoria="odalis" data-etiquetas="Juve sexy autos calles"
            ...
            <div class="item-contenido">
              <img src="https://images.pexels.com/photos/1083822/pexels-photo-1083822.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="">
              <div class="Information">
                  <div class="namePrice">
                       <h5>Producto generico</h5>
                       <h4>Precio <span>$20.00</span></h4>
                  </div>
              </div>
            </div>
          </div>
